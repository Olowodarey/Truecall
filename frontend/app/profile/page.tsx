      ...
      <main className="relative z-10 container mx-auto px-4 pt-32 pb-20">
        <div className="flex flex-col md:flex-row items-center justify-between mb-12 gap-8">
          ...
          <div className="grid grid-cols-3 gap-4 w-full md:w-auto">
            ...
            <StatCard
              label="Accuracy"
              value={`${Math.round((stats.correctPredictions / (stats.totalPredictions || 1)) * 100)}%`}
              icon="🎯"
          ...
          <section>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
              <RewardCard
                ...
                description="Successfully predicted 5 events"
                status="Unlocked"
                icon="🏅"
              />
              <RewardCard
              ...
              <RewardCard
                title="Oracle Master"
                description="Resolved 10 events manually"
                status="Locked"
                icon="🧙‍♂️"
                isLocked
              />
          ...
          <section>
            ...
            {loading ? (
              <div className="flex justify-center py-12">
                <div className="animate-spin rounded-full h-12 w-12 shadow-sm shadow-orange-500/50 border-t-2 border-b-2 border-orange-500"></div>
              </div>
...
function RewardCard({
  ...
  return (
    <div
      className={`p-6 rounded-2xl border transition-all duration-300 ${isLocked ? "bg-gray-800/20 border-gray-800 opacity-60" : "bg-gray-800/50 border-gray-700 hover:border-orange-500/30 hover:shadow-xl hover:shadow-orange-500/5"}`}
    >
